...
/** Override primary Gemini model (e.g. gemini-2.5-flash-preview-05-20) */
  ...
  /** Max Gemini requests per minute (default: 15 free tier; set to 200+ for PAYG) */
  AI_RPM_LIMIT?: string;
  /** Alias for AI_RPM_LIMIT used by the distributed Redis rate limiter */
  AI_THROTTLE_LIMIT?: string;
  /** Daily AI spend cap in USD — warning at 80%, logs at 100% (default: 10) */
  AI_BUDGET_DAILY_USD?: string;
  /** Monthly AI spend cap in USD — warning at 80%, logs at 100% (default: 150) */
