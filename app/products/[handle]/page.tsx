...
export default async function ProductPage({ params }: Props) {
  ...
  const productSchema: Record<string, unknown> = {
    ...
    ...(barcode && barcode.length === 13 ? { gtin13: barcode } : {}),
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Catalogo', item: `${BASE_URL}/products` },
      { '@type': 'ListItem', position: 3, name: productTitleFormatted, item: `${BASE_URL}/products/${params.handle}` },
    ],
  };
      ...
      <div className="container px-4 md:px-8 py-6 md:py-10 pb-24 md:pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* FAQ Section (usa dati reali da metafield, fallback su generati) */}
            <ProductFAQ
              productTitle={productTitleFormatted}
              brandName={brandName}
