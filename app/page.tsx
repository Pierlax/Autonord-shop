...
const organizationSchema = {
  ...
  url: BASE_URL,
  logo: `${BASE_URL}/autonord-logo.png`,
  foundingDate: '2006',
  description: 'Vendita e noleggio di elettroutensili professionali e attrezzature per l\'edilizia. Partner ufficiale Milwaukee, Yanmar, Makita.',
  telephone: '+390107456076',
  address: {
    '@type': 'PostalAddress',
  ...
  sameAs: [
    'https://www.facebook.com/autonordservice',
  ],
};
